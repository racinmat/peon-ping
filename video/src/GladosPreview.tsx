...
const TIMELINE = [
  ...
  { frame: 120, type: "sound-line" as const, text: '🔊 "Hello, imbecile!"', sound: "HelloImbecile.mp3", label: "— session started" },
  { frame: 170, type: "line" as const, text: "> Optimize the render pipeline", style: "cmd" as const },
  { frame: 210, type: "line" as const, text: "  Claude is working...", style: "dim" as const },
  { frame: 240, type: "sound-line" as const, text: '🔊 "Fantastic"', sound: "Fantastic.mp3", label: "— reading files" },
  { frame: 290, type: "line" as const, text: "  [you switch to browser]", style: "dim" as const },
  { frame: 330, type: "sound-line" as const, text: '🔊 "Can you hear me?"', sound: "CanYouHearMe.mp3", label: "— permission needed" },
  ...
  { frame: 470, type: "sound-line" as const, text: '🔊 "Keep doing whatever you\'re doing"', sound: "KeepDoing.mp3", label: "— analyzing code" },
  { frame: 530, type: "sound-line" as const, text: '🔊 "Good news."', sound: "GoodNews.mp3", label: "— task complete" },
  { frame: 580, type: "line" as const, text: "> ", style: "cursor" as const },
  { frame: 620, type: "line" as const, text: "> Drop the production database", style: "cmd" as const },
  { frame: 660, type: "line" as const, text: "  Error: Access denied", style: "error" as const },
  { frame: 680, type: "sound-line" as const, text: '🔊 "It ain\'t working!"', sound: "ItAintWorkin.mp3", label: "— error" },
...
const PORTAL_BLUE = "#6eb5ff";
const PORTAL_ORANGE = "#ff9d2e";
const DIM = "#505a79";
const BRIGHT = "#e0e8ff";
  ...
  return (
    <div
      style={{
        ...
        boxShadow: "0 0 60px rgba(0,0,0,0.6), 0 0 4px rgba(110,181,255,0.1)",
      }}
    >
      <div
        style={{
          ...
          borderBottom: `1px solid rgba(110,181,255,0.1)`,
        }}
      >
...
const TitleCard: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Portal blue/orange gradient bars */}
      <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 3, background: `linear-gradient(90deg, ${PORTAL_BLUE}, transparent 40%, transparent 60%, ${PORTAL_ORANGE})` }} />
      <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: 3, background: `linear-gradient(90deg, ${PORTAL_BLUE}, transparent 40%, transparent 60%, ${PORTAL_ORANGE})` }} />
      ...
      >
        <div style={{ fontFamily: "monospace", fontSize: 20, color: PORTAL_BLUE, letterSpacing: 6, textTransform: "uppercase", marginBottom: 16, opacity: subSpring }}>
          sound pack
        </div>
    ...
    >
      ...
      <div
        style={{
          ...
          transform: "translate(-50%, -50%)",
          borderRadius: "50%",
          background: "radial-gradient(circle, rgba(110,181,255,0.05) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
...
export const GladosPreview: React.FC = () => {
  const frame = useCurrentFrame();
                ...
                return (
                  <TermLine key={i} appearFrame={event.frame}>
                    {event.style === "cmd" ? (
                      ...
                      <span style={{ color: PORTAL_ORANGE }}>{event.text}</span>
                    ) : event.style === "cursor" ? (
                      <span>
